...
function FAQ() {
  const items = [
    ...
    { q: "De unde cumpăr materia primă după primele 300 pahare?", a: "De la noi, pe platformă. Prețuri negociate la volum mare — cafea Beandrops, siropuri și pahare branded." },
